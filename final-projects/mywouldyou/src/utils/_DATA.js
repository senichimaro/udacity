let users = {
  sarahedo: {
    id: "sarahedo",
    name: "Sarah Edo",
    avatarURL: "https://bit.ly/3xC1mqx",
    answers: {
  ...
  tylermcginnis: {
    id: "tylermcginnis",
    name: "Tyler McGinnis",
    avatarURL: "https://bit.ly/3zKMqZS",
    answers: {
  ...
  johndoe: {
    id: "johndoe",
    name: "John Doe",
    avatarURL: "https://bit.ly/39CW06r",
    answers: {
...
/** formatQuestion
 * Helper to create a formated question object
 * from a raw question object,
 * used in _saveQuestion
...
/** _saveQuestion
 * Receives Raw Question object which is formated
 * to be saved in the store, finally returns
 * a Formated Question.
 * @param {Question}
 * @returns {FormatedQuestion}
 */
